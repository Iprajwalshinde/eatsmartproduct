...
<html lang="en">
  <head>
    ...
    <title>Report Fallacy - EatSmart</title>
    <!-- plugins:css -->
  ...
  <body>
            ...
            <h3 class="page-title">
              ...
              <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body ">
                      <h4 class="card-title">Report Fallacy</h4>
                      <p class="card-description ">Check Report Insights</p>
                      ...
                      <div id="detailModal" class="modalDelete">
                        <div class="modal-content-Delete">
                            ...
                            <h2 class="modal-title">Insight Details</h2>
                            <div class="modal-body">
                                <strong>Date & Time</strong><p id="modalDateTime"></p>
                                <strong>Title</strong> <p id="modalTitle"></p>
                                <strong>Description</strong><p id="modalDescription"></p>
                                <strong>Tag</strong><p id="modalTag"></p>
                                <strong>Report Times</strong><p id="modalReportTimes"></p>
                            </div>
    ...
    <script src="assets/js/reportFallacy.js"></script>
